# backstrace
**backstrace** searches for PATTERNS in each file that was opened by a process traced with [strace](https://man7.org/linux/man-pages/man1/strace.1.html). It expects strace to be used with the `-ttt` format and the syscall for `OPEN` to be traced.
